...
export const PERSONAS = {
  ...
  jhammond: { uid: 'seed_jhammond',    name: 'James Hammond', email: 'james@hammondco.io' },
  ksong:    { uid: 'seed_ksong',       name: 'Kelly Song',    email: 'kelly.song@nx.dev' },
  mvelasco: { uid: 'seed_mvelasco',    name: 'Miguel Velasco',email: 'mvelasco@arclabs.io' },
  rwhite:   { uid: 'seed_rwhite',      name: 'Rachel White',  email: 'rachel@quartetops.com' },
  kdiallo:  { uid: 'seed_kdiallo',     name: 'Khadija Diallo',email: 'kd@parallaxgrid.dev' },
  tkonig:   { uid: 'seed_tkonig',      name: 'Tomáš König',   email: 'tk@verdantcloud.eu' },
  png:      { uid: 'seed_png',         name: 'Patrick Ng',    email: 'patrick@sololaunch.studio' },
  evgenia:  { uid: 'seed_evgenia',     name: 'Evgenia Sokolova', email: 'evgenia@northshelf.io' },
  vchen:    { uid: 'seed_vchen',       name: 'Vincent Chen',  email: 'vincent.c@beaconmesh.com' },
  shimizu:  { uid: 'seed_shimizu',     name: 'Hiroshi Shimizu', email: 'shimizu@waveform.jp' },
  shulin:   { uid: 'seed_shulin',      name: '林書豪',          email: 'shulin@tw-craft.dev' },
  ywang:    { uid: 'seed_ywang',       name: '王宇彤',           email: 'ywang@northbridge.co' },
  yuki:     { uid: 'seed_yuki',        name: '田中 雪',          email: 'yuki.t@blueprint.jp' },
  sgupta:   { uid: 'seed_sgupta',      name: 'Sneha Gupta',   email: 'sgupta@orbitech.io' },
};
