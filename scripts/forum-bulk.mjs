...
export const BULK_PERSONAS = {
  bjacobs:   { uid: 'seed_bjacobs',   name: 'Ben Jacobs',       email: 'team@flyto2.com' },
  cmoreno:   { uid: 'seed_cmoreno',   name: 'Carla Moreno',     email: 'team@flyto2.com' },
  dkato:     { uid: 'seed_dkato',     name: 'Daniel Kato',      email: 'team@flyto2.com' },
  efranco:   { uid: 'seed_efranco',   name: 'Elena Franco',     email: 'team@flyto2.com' },
  gnaidu:    { uid: 'seed_gnaidu',    name: 'Gauri Naidu',      email: 'team@flyto2.com' },
  hlund:     { uid: 'seed_hlund',     name: 'Hanna Lund',       email: 'team@flyto2.com' },
  iperez:    { uid: 'seed_iperez',    name: 'Iván Pérez',       email: 'team@flyto2.com' },
  jokafor:   { uid: 'seed_jokafor',   name: 'Jane Okafor',      email: 'team@flyto2.com' },
  klovric:   { uid: 'seed_klovric',   name: 'Krešo Lovrić',     email: 'team@flyto2.com' },
  lnaka:     { uid: 'seed_lnaka',     name: 'Lina Nakamura',    email: 'team@flyto2.com' },
  mhalvor:   { uid: 'seed_mhalvor',   name: 'Magnus Halvorsen', email: 'team@flyto2.com' },
  nbrumm:    { uid: 'seed_nbrumm',    name: 'Nora Brummel',     email: 'team@flyto2.com' },
  ofarah:    { uid: 'seed_ofarah',    name: 'Omar Farah',       email: 'team@flyto2.com' },
  prustad:   { uid: 'seed_prustad',   name: 'Petter Rustad',    email: 'team@flyto2.com' },
  qhuang:    { uid: 'seed_qhuang',    name: '黃詠琪',             email: 'team@flyto2.com' },
  rivanov:   { uid: 'seed_rivanov',   name: 'Roman Ivanov',     email: 'team@flyto2.com' },
  shaque:    { uid: 'seed_shaque',    name: 'Saira Haque',      email: 'team@flyto2.com' },
  tboone:    { uid: 'seed_tboone',    name: 'Theo Boone',       email: 'team@flyto2.com' },
  uakin:     { uid: 'seed_uakin',     name: 'Umut Akın',        email: 'team@flyto2.com' },
  vmadsen:   { uid: 'seed_vmadsen',   name: 'Vibeke Madsen',    email: 'team@flyto2.com' },
  wkurosaki: { uid: 'seed_wkurosaki', name: '黒崎 渉',            email: 'team@flyto2.com' },
  xcheng:    { uid: 'seed_xcheng',    name: '鄭曉雯',             email: 'team@flyto2.com' },
  yokonkwo:  { uid: 'seed_yokonkwo',  name: 'Yusuf Okonkwo',    email: 'team@flyto2.com' },
  zfedorov:  { uid: 'seed_zfedorov',  name: 'Zlata Fedorov',    email: 'team@flyto2.com' },
  aweiss:    { uid: 'seed_aweiss',    name: 'Anya Weiss',       email: 'team@flyto2.com' },
  brye:      { uid: 'seed_brye',      name: 'Benji Rye',        email: 'team@flyto2.com' },
  cdvorak:   { uid: 'seed_cdvorak',   name: 'Clara Dvořák',     email: 'team@flyto2.com' },
  dmello:    { uid: 'seed_dmello',    name: 'Daniela Mello',    email: 'team@flyto2.com' },
  esakai:    { uid: 'seed_esakai',    name: '坂井 恵',            email: 'team@flyto2.com' },
  fnguyen:   { uid: 'seed_fnguyen',   name: 'Felix Nguyễn',     email: 'team@flyto2.com' },
  ghoffer:   { uid: 'seed_ghoffer',   name: 'Greta Hoffer',     email: 'team@flyto2.com' },
  hlaurent:  { uid: 'seed_hlaurent',  name: 'Hugo Laurent',     email: 'team@flyto2.com' },
  ipatel:    { uid: 'seed_ipatel',    name: 'Ishaan Patel',     email: 'team@flyto2.com' },
  jthorpe:   { uid: 'seed_jthorpe',   name: 'Jamie Thorpe',     email: 'team@flyto2.com' },
  kbergen:   { uid: 'seed_kbergen',   name: 'Karl Bergen',      email: 'team@flyto2.com' },
  lschmidt:  { uid: 'seed_lschmidt',  name: 'Lara Schmidt',     email: 'team@flyto2.com' },
  mtanaka:   { uid: 'seed_mtanaka',   name: '田中 真央',           email: 'team@flyto2.com' },
  noh:       { uid: 'seed_noh',       name: 'Naomi Oh',         email: 'team@flyto2.com' },
  oblake:    { uid: 'seed_oblake',    name: 'Oliver Blake',     email: 'team@flyto2.com' },
};
