...
1. **Import the Webpage to PDF Converter** from the Flyto2 template marketplace
2. **Enter the URL** — provide the web page you want to convert to PDF
3. **Run and download** — Flyto2 renders the full page and saves it as a clean PDF file

Process multiple URLs in one batch by providing a list. Each page is saved as a separate, properly named PDF document.
