...
const ENTRIES: Omit<WhitepaperMeta, 'readingMinutes'>[] = [
  ...
  },
  {
    ...
    blurb:
      'Coverage the main audit left out: flyto-core with 466 registry-backed modules, 85 catalog categories, 41 built-in recipes, MCP transport, the expression engine, plugin SDK, and the bits the headline doc skipped.',
  },
  {
    slug: 'code',
