...
const ROWS: Omit<FeatureRow, 'label' | 'title' | 'body' | 'bullets' | 'imageAlt'>[] = [
  { index: '01', image: '/assets/img/warroom/21-scoring-breakdown.png' },     // dashboard / A-F score
  { index: '02', image: '/assets/img/warroom/20-taint-analysis.png' },        // reachability via taint
  { index: '03', image: '/assets/img/warroom/14-frameworks.png' },            // dependencies surface
  { index: '04', image: '/assets/img/warroom/09-architecture-overview.png' }, // architecture
  { index: '05', image: '/assets/img/warroom/15-api-routes.png' },            // API surface
  { index: '06', image: '/assets/img/warroom/17-iac-scanning.png' },          // IaC
  { index: '07', image: '/assets/img/warroom/04-pulse-feed.png' },            // pulse
];
