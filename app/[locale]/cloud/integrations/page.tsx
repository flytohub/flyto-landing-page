...
export async function generateMetadata({
  ...
  return {
    title: 'Integrations — 466 modules',
    description:
      '466 pre-wired modules across CSV, spreadsheets, Stripe, Notion, Slack, AI, databases, browsers and more. Drag, drop, configure.',
...
const GROUPS: IntegrationGroup[] = [
  ...
  },
  {
    ...
    body: 'The plumbing that makes 466 modules into actual workflows.',
